...
const isStringLengthMoreThan = function (length) {
  return function (string) {
    return string.length > length;
  }
}

const isStringLengthMoreThan5 = isStringLengthMoreThan(5);

const filterLongWords = function (words) {
  return words.filter(isStringLengthMoreThan5);
}

// people older than 30 [{name: "Alice", age: 25}, {name: "Bob", age: 35}] => [{name: "Bob", age: 35}]
const isOlderThan = function (age) {
  return function (person) {
    return person.age > age;
  }
}

const isOlderThan30 = isOlderThan(30);
